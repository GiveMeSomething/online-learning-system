 ...
 * @author ADMIN
 */
@WebServlet(name = "InsertUserController", urlPatterns = {"/InsertUser"})
public class InsertUserController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.insertAccount(email, password);
            dao.insertUser(image, fullname, gender, email, roleid, address, status, mobile);
