<%-- 
    Document   : featuredCourse
    Created on : May 31, 2021, 11:57:50 AM
    Author     : Admin
--%>
            ...
            <c:forEach items="${studentsViewCourse}" var="o">
                <div class="col-4" style="height: max-content">
                    <div class="card" style="width: 13rem;">
                        <a href="courseDetail?cid=${o.id}"><img style="cursor: pointer" src="${o.imageLink}" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                            <div style="height:145px">
                                <a href="courseDetail?cid=${o.id}" style="text-decoration: none; color: black"><h5 class="card-title" style="cursor: pointer">${o.courseName}</h5></a>
                                <div class="d-flex">
